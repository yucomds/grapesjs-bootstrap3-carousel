export const
    ...
    styleGen = function (name) {
        return `<style>
                        ...
                        .${name} .sr-only-focusable:active,
                        .${name} .sr-only-focusable:focus {
                          position: static;
                          width: auto;
                          height: auto;
                          margin: 0;
